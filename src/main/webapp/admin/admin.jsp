		...
		<script type="text/javascript">
			$(function() {
				...
				$("#showGoodsType").click(function(){
					// 查看商品分类
					$(".dv_content").attr("src","${pageContext.request.contextPath }/showGoodsType?action=showType");
				})
				...
				$("#showGoods").click(function(){
					// 查看商品
					$(".dv_content").attr("src","${pageContext.request.contextPath }/showGoods?action=showGoods");
				})
					...
					<ul id="sub3" class="nav panel-collapse collapse">
						<li>
							<a href="#" id="showGoodsType">
								<span class="glyphicon glyphicon-record" id="jiazai" ></span>&nbsp;&nbsp;查看商品分类
							</a>
						</li>
						<li>
